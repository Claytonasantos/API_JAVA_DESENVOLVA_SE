...
public class UsuarioResource {
    ...
    public Response inserirUsuRs(Usuario usuario, @Context UriInfo uriInfo ) throws ClassNotFoundException, SQLException {
        ...
        builder.path(Integer.toString(usuario.getId_usu()));
    ...
    @PUT
    @Consumes(MediaType.APPLICATION_JSON)
    public Response atualizarUsuRs(Usuario usuario, @PathParam("id_usu") int id_usu) throws ClassNotFoundException, SQLException {
    ...
    @Path("/{id_usu}")
    @Consumes(MediaType.APPLICATION_JSON)
    public Response deletarUsuRs(@PathParam("id_usu") int id_usu) throws ClassNotFoundException, SQLException {
        usuarioBO.deletarUsuarioBo(id_usu);
        return Response.ok().build();
    }
